...
ChatLogic::ChatLogic()
{
    ...
    //_chatBot = new ChatBot("../images/chatbot.png"); This is no longer Needed.

    // add pointer to chatlogic so that chatbot answers can be passed on to the GUI
    //_chatBot->SetChatLogicHandle(this); This is no longer needed.
...
ChatLogic::~ChatLogic()
{
    ...
    //delete _chatBot; This is no longer needed.
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    // Add pointer to chatLogic so that chatBot answers can be passeed on to GUI
